...
shipping_agent = LlmAgent(
    ...
    instruction="""You are a shipping coordinator assistant.Notice the function signature includes `tool_context: ToolContext`. ADK automatically provides this object when your tool runs. It gives you two key capabilities:
