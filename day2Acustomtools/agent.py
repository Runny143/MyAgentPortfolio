...
from google.adk.tools import AgentTool, google_search , tool_context
...
currency_agent = LlmAgent(
    ...
    4. Generate a Python code to calculate the final amount based on the output from `get_fee_for_payment_method` and `get_exchange_rate` and use the 'calculation_agent' to run the code and compute final amount.
